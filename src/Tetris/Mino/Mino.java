...
public class Mino {
    ...
    public int direction = 1; // The direction of the Mino. Number 1 is default, then the others is based on
    ...
    public void draw(Graphics2D graphics2D) {
        ...
        graphics2D.fillRect(block[0].x + margin, block[0].y + margin, Block.SIZE - (margin * 2),
                Block.SIZE - (margin * 2));
        graphics2D.fillRect(block[1].x + margin, block[1].y + margin, Block.SIZE - (margin * 2),
                Block.SIZE - (margin * 2));
        graphics2D.fillRect(block[2].x + margin, block[2].y + margin, Block.SIZE - (margin * 2),
                Block.SIZE - (margin * 2));
        graphics2D.fillRect(block[3].x + margin, block[3].y + margin, Block.SIZE - (margin * 2),
                Block.SIZE - (margin * 2));
    }
